...
class VerifyPhoneNumber extends StatefulWidget {
  static const String routeName = 'VerifyPhoneNumberScreenRoute';
  ...
  @override
  State<VerifyPhoneNumber> createState() => _ResetViaSmsScreenState();
}

class _ResetViaSmsScreenState extends State<VerifyPhoneNumber> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "We’ve sent a verification code to 012**075. Please check your mobile device and enter the code.",
                  style: TextStyle(
